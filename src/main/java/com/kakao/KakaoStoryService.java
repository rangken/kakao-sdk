...
public class KakaoStoryService {
    ...
    public static void requestProfile(final KakaoStoryHttpResponseHandler<KakaoStoryProfile> responseHandler) {
        ...
        BoundRequestBuilder requestBuilder = HttpRequestTask.ASYNC_HTTP_CLIENT.prepareGet(url);
        APIHttpRequestTask.addTokenHeader(requestBuilder);
        APIHttpRequestTask.checkSessionAndExecute(new APIHttpRequestTask<KakaoStoryProfile>(requestBuilder.build(), responseHandler, KakaoStoryProfile.class), responseHandler);
    }
    ...
    public static void requestGetMyStory(final KakaoStoryHttpResponseHandler<MyStoryInfo> responseHandler, final Bundle parameters) {
        ...
        APIHttpRequestTask.checkSessionAndExecute(new APIHttpRequestTask<MyStoryInfo>(requestBuilder.build(), responseHandler, MyStoryInfo.class), responseHandler);
    }
    ...
    public static void requestGetLinkInfo(final KakaoStoryHttpResponseHandler<KakaoStoryLinkInfo> responseHandler, final String linkUrl) {
        ...
        APIHttpRequestTask.addQueryParams(requestBuilder, parameters);
        APIHttpRequestTask.checkSessionAndExecute(new APIHttpRequestTask<KakaoStoryLinkInfo>(requestBuilder.build(), responseHandler, KakaoStoryLinkInfo.class), responseHandler);
    }
    ...
    public static void requestMultiUpload(final KakaoStoryHttpResponseHandler<String[]> responseHandler, final List<File> files) throws FileNotFoundException {
        ...
        APIHttpRequestTask.checkSessionAndExecute(new APIHttpRequestTask<String[]>(requestBuilder.build(), responseHandler, String[].class), responseHandler);
    }

    /**
     * 카카오스토리에 포스팅 요청
     * @param type 포스팅 타입. {@link com.kakao.KakaoStoryService.StoryType}
    ...
    /**
     * {@link #requestPost(com.kakao.KakaoStoryService.StoryType, KakaoStoryHttpResponseHandler, android.os.Bundle)}를 사용하도록 하낟.
     */
    @Deprecated
