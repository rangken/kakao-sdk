 ...
 * @author MJ
 */
public abstract class PushRegisterHttpResponseHandler extends HttpResponseHandler<Integer> {
    ...
    protected PushRegisterHttpResponseHandler(final String regId, final int appVer) {
        setRegId(regId, appVer);
    }
     ...
     */
    public void setRegId(final String regId, final int appVer) {
        this.regId = regId;
        this.appVer = appVer;
    }
    ...
    protected void onHttpSuccess(final Integer expiredAt) {
        PushToken.savePushTokenToCache(regId, appVer, expiredAt);
